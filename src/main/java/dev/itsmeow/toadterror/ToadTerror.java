...
public class ToadTerror {
    ...
    public static void registerSoundEvents(final RegistryEvent.Register<SoundEvent> event) {
        event.getRegistry().registerAll(ModSoundEvents.TOAD_SENTINEL_RIBBIT, ModSoundEvents.TOAD_SENTINEL_DEATH, ModSoundEvents.TOAD_SENTINEL_HURT, ModSoundEvents.TOAD_SENTINEL_IDLE);
    }
    ...
    public static class EventListener {
        ...
        public static void onCuriosDeath(LivingCurioDropsEvent event) {
            if(event.getEntityLiving() instanceof PlayerEntity) {
                for(ItemEntity itemE : event.getDrops()) {
                    ...
                    if(!stack.isEmpty() && stack.getItem() == ModItems.EMPTY_TOAD_EYE && stack.hasTag() && stack.getTag().contains("uid") && !stack.getTag().contains("noLocate")) {
                        CompoundNBT newTag = writeEntityToEye((PlayerEntity) event.getEntityLiving(), UUID.fromString(stack.getTag().getString("uid")));
                        ItemStack newStack = new ItemStack(newTag.contains("noLocate") ? ModItems.EMPTY_TOAD_EYE : ModItems.TOAD_EYE);
                        newStack.setTag(newTag);
        ...
        public static void onItemDropped(ItemTossEvent event) {
            ItemEntity itemE = event.getEntityItem();
            ItemStack stack = itemE.getItem();
            if(!stack.isEmpty() && stack.getItem() == ModItems.EMPTY_TOAD_EYE && stack.hasTag() && stack.getTag().contains("uid") && !stack.getTag().contains("noLocate")) {
                CompoundNBT newTag = writeEntityToEye(event.getPlayer(), UUID.fromString(stack.getTag().getString("uid")));
                ItemStack newStack = new ItemStack(newTag.contains("noLocate") ? ModItems.EMPTY_TOAD_EYE : ModItems.TOAD_EYE);
                newStack.setTag(newTag);
                itemE.setItem(newStack);
            }
